...
const BLOG_POSTS = {
  'generics-vs-brands': {
    ...
    tag: "Economics",
    date: "Apr 09, 2024",
    img: "https://images.unsplash.com/photo-1579152276503-34e8574d6c42?auto=format&fit=crop&q=80&w=1200",
    content: `
      ...
      <div className="pt-32 pb-24 px-6 md:px-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
             ...
             <h1 className="text-5xl md:text-7xl font-black text-[#15342C] font-['Outfit'] leading-tight tracking-tighter mb-10">
               {post.title}
             </h1>

             {/* Photo Just Below Title */}
             <div className="aspect-[16/8] rounded-[3.5rem] overflow-hidden mb-12 shadow-3xl">
          ...
          <div className="bg-white p-12 md:p-20 rounded-[4rem] shadow-2xl border border-slate-50 relative">
             ...
             <div className="mt-20 pt-12 border-t border-slate-50 flex flex-wrap items-center justify-between gap-10">
                <div className="flex items-center gap-8">
                   ...
                   <div>
                      <h4 className="font-black text-[#15342C] font-['Outfit'] text-xl tracking-tight">Verified by PharmaZone AI</h4>
                      <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em] mt-1">Medical Research Wing • Sector 09</p>
                   </div>
                </div>
                <button onClick={() => navigate('/search')} className="bg-[#F4A522] text-[#15342C] px-10 py-5 rounded-full font-black uppercase text-xs tracking-widest shadow-xl">Search Molecules →</button>
             </div>
          </div>
        </div>
      </div>
